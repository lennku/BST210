...
__Age is associated with history of premature labor, associated with birth weight regardless of history of premature labor, and is not a downstream consequence of history of premature labor and birth weight. Thus, age is a confounder of the association between history of premature labor and birth weight. The coefficient of ptd is 6.09 when it is matched upon, and when it is not matched upon, it is 1.97 The difference is greater than a 10% percent change. As age is a meaningful confounder of the association between history of premature labor and birth weight, it is important to adjust for (matched) age or stratum.__ 
...
__We get similar beta coefficients (and both statistically significant) for PTD between the conditional logistic regression and unconditional logistic regression model (1.93 vs 1.97).  However, this is not a good approach to use because our study was conducted by matching cases and controls by age, and the unconditional logistic regression method deviates from the original intent of our study.__ 
...
__The IRR for the effects of 20 cigarettes/day, adjusting for smoking duration is exp((20)(0.0667)), or 3.80, with a 95% CI of (exp(20(0.0667 - (1.96)0.00632), exp(20(0.0667 + (1.96)0.00632)), or (2.96, 4.87). The deviance measures are more than 1 times the degree of freedom, suggesting that this model has variance > mean and lacks good fit. There are no good GOF tests for Poisson models with large number of covariate patterns (as is in this case), but taking the ratio of deviance to df can be one way to assess generally if the model is overdispersed.__  

__Because of potential evidence of lack of fit and to consider possible nonlinear effects of cigpday and smokedur on lung cancer incidence, a number of additional analyses should be performed.__
